...
const baseStyles =
  'inline-flex bg-white text-black border border-gray-300 hover:bg-gray-100 items-center justify-center px-4 py-2 border text-sm font-medium rounded transition focus:outline-none focus:ring-2 focus:ring-offset-2';
